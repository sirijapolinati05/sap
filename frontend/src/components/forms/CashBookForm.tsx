        ...
        <div className="p-6 flex-1 overflow-y-auto bg-white">
          <div className="space-y-6 max-w-4xl">
            ...
            <div className="relative">
              <input type="text" placeholder="Voucher No" className="w-full border border-gray-400/60 rounded-md py-3 px-3 text-sm bg-white focus:outline-none focus:border-blue-500 shadow-[inset_0_3px_6px_rgba(0,0,0,0.15),0_1px_0_rgba(255,255,255,1)] " />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="relative">
                ...
                <div className="flex w-full">
                  <input type="text" defaultValue="22-Sep-2026" className="w-full border border-gray-400/60 border-r-0 rounded-l-md py-3 px-3 text-sm bg-white focus:outline-none focus:border-blue-500 shadow-[inset_0_3px_6px_rgba(0,0,0,0.15),0_1px_0_rgba(255,255,255,1)] " />
              ...
              <div className="relative">
                <div className="absolute top-0 left-0 w-2 h-2 bg-red-500 z-10 rounded-tl-md" style={{ clipPath: 'polygon(0 0, 100% 0, 0 100%)' }}></div>
                <input type="text" placeholder="Amount" className="w-full border border-gray-400/60 rounded-md py-3 px-3 text-sm bg-white focus:outline-none focus:border-blue-500 shadow-[inset_0_3px_6px_rgba(0,0,0,0.15),0_1px_0_rgba(255,255,255,1)] " />
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <textarea 
                ...
                className="w-full border border-gray-400/60 rounded-md pt-7 pb-3 px-3 text-sm bg-white focus:outline-none focus:border-blue-500 shadow-[inset_0_3px_6px_rgba(0,0,0,0.15),0_1px_0_rgba(255,255,255,1)]  resize-none h-32"
              ></textarea>
            </div>
          </div>
        </div>
